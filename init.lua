...
require('lazy').setup({
  -- Configuration for nvim-neo-tree
  {
    ...
    opts = {
      filesystem = {
        ...
        filtered_items = {
          ...
          never_show = { -- remains hidden even if "show hidden" is toggled
            '.DS_Store',
            '.DS_Store_hidden_message',
          },
        },
  ...
  --         'NormalFloat',
  --         'NvimTreeNormal',
  --         'GruvboxBg0', -- Specific to Gruvbox
  --         'GruvboxRedSign', -- Specific to Gruvbox
  --         'GruvboxGreenSign', -- Specific to Gruvbox
  --       },
  --     }
  --   end,
  -- },
  {
    ...
    config = function()
      require('lualine').setup {
        options = {
          -- This will automatically detect your theme!
          -- theme = 'auto',
          theme = 'gruvbox',
          component_separators = { left = '|', right = '|' },
          section_separators = { left = '', right = '' }, -- 'Hard' themes look great with flat edges
  ...
  },
  {
    ...
    config = function()
      require('gruvbox').setup {
        ...
        contrast = 'hard',
        palette_overrides = {
          dark0 = '#1e2326', -- This is the magic greenish-dark hex
        },
        -- Disable italics here:
        overrides = {
          -- This looks for any group with 'italic' and turns it off
  ...
  --       -- This style configuration covers the most common italicized groups
  --       styles = {
  ...
  --       },
  --       -- This global setting helps catch any remaining italics
  ...
  --   priority = 1000,
  --   config = function()
  --     -- The setup and load logic for github-theme is now separate
  --     require('github-theme').setup {
  --       options = {
  --         transparent = false,
  --         hide_end_of_buffer = true,
  --         -- Styles now expect a single string like "italic,bold"
  --         styles = {
  --           comments = 'italic',
  --           keywords = 'bold',
  --           types = 'bold',
  ...
  --     }
  --
  --     -- This is the specific command to load the dimmed variant
  --     vim.cmd 'colorscheme github_dark'
  --
  --     -- Overrides to keep that previous logic you liked
  --     -- We use a safe pcall to fetch the palette so it doesn't crash if the theme name changes
  --     local status, _ = pcall(require, 'github-theme.lib')
  --     if status then
  --       local palette = require('github-theme.palette').load 'github_dark'
  --       vim.api.nvim_set_hl(0, 'Comment', { fg = palette.orange, italic = true })
  --       vim.api.nvim_set_hl(0, 'WinSeparator', { fg = palette.bg3 })
  --     end
  --   end,
  -- },
  ...
  --
  --         keyword = { italic = false }, -- disable italics in keywords
  --
  --       },
  --     }
  --
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --
      --    -- Base16 themes sometimes benefit from a more "flat" statusline
      --    content = {
      --      active = nil,
      --    },
      --  }
...
-- [[ Custom Autosave ]]
-- Save when leaving insert mode or losing focus
-- Autocommand to save the current buffer when leaving insert mode or switching windows
vim.api.nvim_create_autocmd({ 'CursorHold', 'CursorHoldI', 'InsertLeave', 'BufLeave', 'FocusLost' }, {
  group = vim.api.nvim_create_augroup('autosave', { clear = true }),
  callback = function()
    -- Check if the buffer is modifiable, has a file name, and is not a quickfix/terminal buffer
    if vim.bo.modified and not vim.bo.readonly and vim.bo.modifiable and vim.fn.bufname '%' ~= '' and vim.bo.buftype == '' then
      vim.cmd 'silent! update' -- Use 'update' instead of 'write' to only save if changed
    end
  end,
})

-- Additionally, you can set `autowriteall` to automatically save when switching buffers
